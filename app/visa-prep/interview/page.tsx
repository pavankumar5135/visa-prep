...
export default function InterviewPage() {
  ...
  // No need for separate effects for minutes - the MinutesProvider handles that now
  ...
  const confirmBackToDashboard = () => {
    ...
    window.location.href = '/visa-prep/dashboard';
  };
                      ...
                      {supabaseUser ? (
                        ...
                        >
                          <div className="flex items-center">
                            ...
                            <span>Available: <MinutesValue agentId={process.env.NEXT_PUBLIC_SUPA_VISA_PREP_AGENT_UUID} /></span>
                          </div>
                        </MinutesProvider>
                      ) : (
