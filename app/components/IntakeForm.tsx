            ...
            <div className="flex flex-row gap-2">
              ...
              {isEditMode && (
                <button
                  ...
                  className="w-full xs:w-auto px-8 py-3 border border-gray-300 rounded-2xl shadow-sm text-lg font-medium text-red-400 bg-white hover:bg-red-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-colors"
                >
                  Clear
                </button>
              )}
